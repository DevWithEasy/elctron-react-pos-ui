                ...
                <div className='w-1/2'>
                    ...
                    >
                        <input
                            ...
                            className='w-full p-2 border rounded-md focus:outline-blue-500 placeholder:text-sm'
                        ...
                        >
                            ...
                            >
                                <input
                                    ...
                                    className='w-1/2 p-2 border rounded-md focus:outline-blue-500 placeholder:text-sm'
